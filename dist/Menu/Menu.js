...
var Menu = /*#__PURE__*/function (_React$Component) {
  function Menu(props) {
    ...
    _this2 = _callSuper(this, Menu, [props]);
    _this2.menu = /*#__PURE__*/React.createRef();
    _this2.state = {
      expanded: false
    };
    _this2.onTriggerClick = _this2.onTriggerClick.bind(_this2);
    _this2.onCloseClick = _this2.onCloseClick.bind(_this2);
    _this2.onKeyDown = _this2.onKeyDown.bind(_this2);
    _this2.onDocumentClick = _this2.onDocumentClick.bind(_this2);
  ...
  return _createClass(Menu, [{
    ...
    value: function getAttributesFromProps() {
      ...
      Object.keys(this.props).filter(function (property) {
        ...
        attributes[property] = _this3.props[property];
      });
      return attributes;
    }
  }, {
    ...
    value: function render() {
      ...
      var wrappedChildren = React.Children.map(this.props.children, function (child) {
        if (child.type === MenuTriggerType) {
          return _this4.renderTrigger(child);
        }
        return _this4.renderMenuContent(child);
      });
